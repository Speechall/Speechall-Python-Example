...
from speechall.models.remote_transcription_configuration import (
...
def setup_client():
    ...
    if not api_token:
        ...
        print(
            "Export your API token like: export SPEECHALL_API_TOKEN='your-token-here'"
        )
        sys.exit(1)
...
def transcribe_remote_url(api_instance, audio_url, model_id="openai.whisper-1"):
    ...
    try:
        ...
        print("✅ Transcription completed!")
        print(f"📝 Result: {result.segments}")
